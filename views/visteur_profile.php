            ...
            <div class="p-6">
                ...
                <form action="profile.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-4">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" placeholder="Username" type="text" value="<?php echo htmlspecialchars($userData['firstName'] . ' ' . $userData['lastName']); ?>" readonly/>
                    </div>
                    <div class="mb-4">
